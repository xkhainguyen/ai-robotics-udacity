"""Reference from Jeremy Shannon
https://github.com/jeremy-shannon/udacity-AI-for-robotics/blob/master/Project%20-%20Runaway%20Robot/studentMain4-chasingWithAPlan.py

NOTE: It often fails and requires more steps if successful
"""
...
def demo_grading(hunter_bot, target_bot, next_move_fcn, OTHER = None):
    ...
    max_distance = 0.7 * target_bot.distance # 1.94 is an example. It will change.
